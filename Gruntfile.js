module.exports = function(grunt) {
        ...
        react: {
            dynamic_mappings: {
                files: [
                    ...
                    {
                        expand: true,
                        cwd: './test/unit-tests/ui-components/src',
                        src: ['**/**.jsx'],
                        dest: './test/unit-tests/ui-components/dest',
                        ext: '.test.js'
                    }
                ]
            }
            ...
            all: {
                options: {
                    files: [{
                        ...
                        pattern: 'test/unit-tests/**/**.test.js',
                        included: false
                    }, {
    ...
    grunt.registerTask('test', ['build', 'karma:all', 'casperjs']);
};
